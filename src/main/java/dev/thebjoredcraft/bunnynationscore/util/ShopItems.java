...
public enum ShopItems {
    ...
    DIAMOND_PICKAXE(new ShopItem(Material.DIAMOND_PICKAXE, ShopManager.diapicke_name, MiniMessage.miniMessage().deserialize("<color:#3b92d1>Silke"), 400, 8)),
    ...
    DIAMOND_PICKAXE_GLUECKY(new ShopItem(Material.DIAMOND_PICKAXE, ShopManager.gluecky_name, MiniMessage.miniMessage().deserialize("<color:#3b92d1>Gluecky"), 400, 11)),
    ...
    HELM(new ShopItem(Material.DIAMOND_HELMET, ShopManager.helm, MiniMessage.miniMessage().deserialize("<color:#3b92d1>Alter Helm"), 2500, 13)),
    CHESTPLATE(new ShopItem(Material.DIAMOND_CHESTPLATE, ShopManager.chestplate, MiniMessage.miniMessage().deserialize("<color:#3b92d1>Alter Harnisch"), 5000, 14)),
    LIGGINGS(new ShopItem(Material.DIAMOND_LEGGINGS, ShopManager.leggings, MiniMessage.miniMessage().deserialize("<color:#3b92d1>Alte Hose"), 5000, 15)),
    BOOTS(new ShopItem(Material.DIAMOND_BOOTS, ShopManager.boots, MiniMessage.miniMessage().deserialize("<color:#3b92d1>Alte Schuhe... Fehlt einer?"), 2500, 16)),
